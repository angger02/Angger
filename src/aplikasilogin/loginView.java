...
public class loginView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String _password = new String (jPasswordField1.getPassword()); 
        if (username.equalsIgnoreCase(_username)&& password.equalsIgnoreCase(_password)){
            view2 vi = new view2(_username);
            vi.setLocationRelativeTo(null);
            vi.setVisible(true);
            this.setVisible(false);
        }else{
            JOptionPane.showMessageDialog(null,"username dan password nya lupa kan","message!",
